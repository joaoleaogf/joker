...
input_edges_file = "GrafosGrupo7-main/referencial/arestas_otimizadas.json"
output_weights_file = "GrafosGrupo7-main/esquinas/arestas_pesos.json"
output_adjacency_list_file = "GrafosGrupo7-main/esquinas/adjacency_list.json"
output_areas_file = "GrafosGrupo7-main/esquinas/areas_list.json"
...
with open(output_areas_file, "w") as file:
    json.dump(areasMap, file, indent=4)
